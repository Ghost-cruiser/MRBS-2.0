(function(){
    ...
    function AuthenticationService($http, $cookies, $rootScope) {
        ...
        function Login(username, password, callback) {
            ...
            //$timeout(function () {
            //    var response;
            //    var auht = UserService.GetByUsername(username);
            //    if (auht !== null && auht.password === password) {
            //                response = { success: true };
            //            } else {
            //                response = { success: false, message: 'Le nom d\'utilisateur ou le mot de passe est incorrecte.' };
            //            }
            //            callback(response);
            //}, 1000);
